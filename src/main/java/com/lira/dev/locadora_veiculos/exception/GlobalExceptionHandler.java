...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(VeiculoBadRequestException.class)
    public ResponseEntity<ErrorResponse> veiculoBadRequestHandler(VeiculoBadRequestException ex){
    ...
    public ResponseEntity<ErrorResponse> MethodArgumentNotValidHandler(MethodArgumentNotValidException exception){
        ...
        VeiculoBadRequestException minhaExcecao = new VeiculoBadRequestException(msg);

        return veiculoBadRequestHandler(minhaExcecao);
    }
